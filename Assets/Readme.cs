 ...
 * 
 *      It includes ;
 *      -Game Title (You can choose your own) -- OK
 *      -Tap To Play Button and Text -- OK
 *      -Current Level Number -- OK
 *      -Currency Amount -- OK
 *      -Start Stack Upgrade Button & Price -- OK
 *
 *      Start Stack Upgrade Button :
 *      This button will consume our currency and increase our starting stack. -- OK
 *
 *  In Game :
 ...
 *
 *      Stack Amount :
 *      This must be attached to and move with the character as smooth as possible. -- OK
 *
 *  Level End :
 *      This screen will appear after we reached our finish line. -- OK
 *
 *      It includes ;
 *      -Level Completed Text -- OK
 *      -Collected Currency Amount -- OK
 *      -Next Level Button -- OK
 *
 * !!UI elements must be responsive and works well with different resolutions. -- OK
 *      
 * GAMEPLAY
 * -----
 *
 *  Input :
 *      Character moves left and right with drag input. -- OK
 *      Movement needs to be simple and as smooth as possible. -- OK
 *
 *  Character :
 *      Character moves with the given animations. -- OK
 *      Character needs a maximum stack limit. -- OK
 *      Character animations need a transition between them. -- OK
 *          If there is no stack "Run1", if stack is full "Run2" needs to be played. -- OK
 *          States between also needs to affect the animation. -- OK
 *      Transitions needs to be as smooth as possible. -- OK
 *      On Level End, character must dance. -- OK
 *
 *  Collectables :
 ...
 *      -Currency -- OK
 *
 *      Stack : Will increase out total stack amount. -- OK
 *      Currency : Will increase out total currency amount. -- OK
 *      
 *  Obstacles :
 *      Obstacles covers a part of the road. -- OK
 *      If character cannot avoid them, current stack amount will decrease. -- OK
 *
 *
 * GAME DATA
 * -----
 * 
 *  Levels :
 *      There must be minimum 2, maximum 5 different levels. -- OK
 *      Level number must increase if you reach finish. -- OK
 *      Level number must be remembered if game is closed and opened again. -- OK
 *      After your last unique level finished, you must repeat them. -- OK
 *
 *  Currency :
 *      Currency Amount must be remembered if game is closed and opened again. -- OK
 *      The amount will increase after collecting a currency collectable and, decreases after using upgrade button. -- OK
 *
 *  Start Stack Upgrade Button :
 *      Start stack represent the amount that our stack at start. -- OK
 *      Start stack start with 0 and increases by 1 with upgrade button on the tap to play screen. -- OK
 *      Upgrade Button price increase exponentially on each purchase action. -- OK
 *      Start Stack amount must be remembered if game is closed and opened again. -- OK
 *      Upgrade Button price and level must be remembered if game is closed and opened again. -- OK
 *
 * !!You can define collectable values and upgrade prices by yourself.
 * !!There will be no fail condition. -- OK
 *
 *
 * !!IMPORTANT!!
